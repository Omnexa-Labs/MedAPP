...
export default function HandoffPage() {
  ...
  useEffect(() => {
    ...
    if (!code.current) {
      setError("Open a new pharmacy link from MedApp.");
      return;
    }
    ...
    <main className="min-h-screen bg-slate-50 px-4 py-12">
      <section className="mx-auto max-w-md rounded-xl border bg-white p-8 shadow-sm">
        ...
        <p className="mt-2 text-slate-600">
          Confirm your account to open the pharmacy you selected in MedApp.
        </p>
        {error && (
          <p
            role="alert"
        ...
        {details && (
          <div className="mt-6">
            ...
            <p className="mt-4 text-sm text-slate-600">
              ...
              to MedApp to close the pharmacy session.
            </p>
            <button
            ...
            >
              {busy ? "Opening pharmacy access…" : "Continue with this account"}
            </button>
          </div>
        )}
