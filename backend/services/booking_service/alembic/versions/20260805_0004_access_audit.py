"""create access_audit (PHI access trail) for booking_service
...
WHAT AND WHY
------------
Before this revision, booking_service could not answer "who read this patient's
...
expose a practitioner's schedule, i.e. which patients a clinician is seeing and when.
