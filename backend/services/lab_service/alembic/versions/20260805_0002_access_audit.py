"""create access_audit (PHI access trail) for lab_service
...
WHAT AND WHY
------------
Before this revision, lab_service could not answer "who read this patient's
...
expose lab results — `raw_text`, `parsed_values`, `summary`.
