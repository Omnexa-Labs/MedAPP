"""create access_audit (PHI access trail) for hospital_service
...
WHAT AND WHY
------------
Before this revision, hospital_service could not answer "who read this patient's
...
expose a hospital's staff roster — a list of people and where each works.
