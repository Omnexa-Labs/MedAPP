"""create access_audit (PHI access trail) for telemedicine_service
...
WHAT AND WHY
------------
Before this revision, telemedicine_service could not answer "who read this patient's
...
expose consultation chat transcripts.
