...
# SQLite shims for Postgres types — same approach as pharmacy_service.
# See that conftest for the rationale; ARRAY bind/result processors
# are dialect-aware so Postgres code paths are untouched.
